...
(function (a) {
    ...
    a.extend(!0, d.defaults, {
        dom: "<'row g-0'<'dataTable-top'<'dataTable-selector'l><'dataTable-search'f>>><'row g-0'<'se-pre-con bg-white opacity-9'tr>><'row g-0'<'dataTable-bottom'ip>>",
        renderer: "bootstrap",
    });
    a.extend(d.ext.classes, {
        ...
        sProcessing: "dataTables_processing card bg-dark text-white opacity-8",
    ...
    d.ext.renderer.pageButton.bootstrap = function (f, l, A, B, m, t) {
        ...
        y(
            a(l)
                .empty()
                .html('<ul class="dataTable-pagination-list"/>')
                .children("ul"),
            B
        );
        z !== e &&
